							...
							<div style="padding-bottom: 20px;">
								...
								<div style="padding: 5px;background: rgb(234, 231, 231);height: 40px;">
									...
									<div style="float: left;"><!-- Baidu Button BEGIN -->
											<div id="bdshare" class="bdshare_t bds_tools_32 get-codes-bdshare"  data='{"text":"大家好，我刚刚通过问卷卷制作了一份调查问卷“${survey.surveyName }”，需要您的帮助，您的意见非常重要。快快来吧帮忙回答。", "url":"http://www.diaowen.net/wenjuan/${survey.sid }.html","pic":"http://www.diaowen.net/images/logo/200-200.png"}'>
												<a class="bds_qzone"></a>
												<a class="bds_tsina"></a>
												<a class="bds_tqq"></a>
